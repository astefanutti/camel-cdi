...
import org.apache.camel.cdi.se.bean.CamelContextProducerMethod;
...
public class CamelContextProducerMethodTest {
    ...
    public void verifyProducedCamelContext(CamelContext context) {
        assertThat("The producer method sets the context name!", context.getName(), is(equalTo("camel-produced")));
