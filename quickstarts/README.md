...
The examples can be individually launched using the `Main` class that is provided by Camel CDI (directly from the IDE or the `java` command) or using the Exec Maven plugin:
